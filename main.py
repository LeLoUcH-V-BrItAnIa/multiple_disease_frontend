...
""", unsafe_allow_html=True)
    ...
    st.markdown("<h1 class='fade-subheading',style='text-align: center;background-size: 600% 600%;font-size: 500px;font-weight: 800;'>🏥 CareIQ: Predict Prevent Personalize 🧠</h1>", unsafe_allow_html=True)
#     st.markdown("""
#     <h1 style="
